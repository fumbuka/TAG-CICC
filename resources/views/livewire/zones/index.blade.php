<div class="py-8">
    <div class="mx-auto max-w-7xl space-y-6 px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <h1 class="text-2xl font-semibold text-gray-950">
                    {{ $section === 'list' ? __('messages.existing_zones') : __('messages.add_zone') }}
                </h1>
                <p class="mt-1 text-sm text-gray-600">{{ __('messages.zone_help') }}</p>
            </div>
            @if ($section === 'list' && $canCreateZones)
                <a href="{{ route('zones.index', 'create') }}" wire:navigate class="inline-flex items-center justify-center rounded-md bg-red-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition hover:bg-red-800">
        ...
        @if ($section !== 'list' && $canImportZones)
        <section
